...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Maio-2017 às 11:04
...
--
-- Database: `corsariosbaja`
--
CREATE DATABASE IF NOT EXISTS `corsariosbaja` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `corsariosbaja`;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tipopeca`
--
...
--
-- Extraindo dados da tabela `tipopeca`
--
...
--
-- Extraindo dados da tabela `tipopista`
--
...
--
--
-- Estrutura da tabela `arquitetura`
--
--
--
...
--
-- Extraindo dados da tabela `arquitetura`
--
...
--
-- Estrutura da tabela `desempenhoteste`
--
...
--
-- Extraindo dados da tabela `desempenhoteste`
--
...
CREATE TABLE IF NOT EXISTS `investidor` (
  `idInvestidor` int(11) NOT NULL,
  `valorDoado` float NOT NULL,
  `FK_pessoa` int(11) NOT NULL,
  PRIMARY KEY (`idInvestidor`),
  KEY `FK_pessoa_investidor` (`FK_pessoa`)

) ENGINE=InnoDB DEFAULT CHARSET=utf8;

ALTER TABLE `investidor`
  ADD CONSTRAINT `FK_pessoa_investidor` FOREIGN KEY (`FK_pessoa`) REFERENCES `pessoa` (`idPessoa`) ON UPDATE CASCADE;
--
-- Extraindo dados da tabela `investidor`
--

INSERT INTO `investidor` (`idInvestidor`, `valorDoado`, `FK_pessoa`) VALUES
(1, 500, 1),
(2, 10, 2),
(3, 50, 3),
(4, 100, 4),
