            ...
            <table border align="center">
                ...
                <tr> 
                    <td  align="center" colspan="9"> 
                        <form class="form" action="RelatorioArquiteturaController" method="POST">
                            <input type="text" name="relatorioNome" value="/reportArquitetura.jasper">
                            <input type="button" value="Imprimir" onclick="window.location.href = 'RelatorioArquiteturaController'">
