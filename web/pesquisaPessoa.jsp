                    ...
                    <tbody>
                        <c:forEach items="${pessoas}" var="pessoa">
                            <tr>
                                ...
                                <td><a class="brown-text text-darken-4" href="ManterPessoaController?acao=prepararEditar&idPessoa=<c:out value="${pessoa.idPessoa}" />">Editar</a></td>
                                <td><a class="brown-text text-darken-4" href="ManterPessoaController?acao=prepararExcluir&idPessoa=<c:out value="${pessoa.idPessoa}" />">Excluir</a></td>
                            </tr>
                        </c:forEach>
                        <tr> 
