         ...
         <SCRIPT language="JavaScript">
            ...
            function validarFormulario(form) { 
                ...
                if (form.txtAceleracaoMedia.value == ""){
                    mensagem = mensagem + "Informe a Aceleração Media\n";
                }
                if (!campoNumerico(form.txtAceleracaoMedia.value)){
                    mensagem = mensagem + "O campo Aceleração Média deve ser numérico\n";
                }
                if (form.txtVelocidadeMedia.value == ""){
                    mensagem = mensagem + "Informe a Velocidade Média\n";
                }
                if (!campoNumerico(form.txtVelocidadeMedia.value)){
                    mensagem = mensagem + "O campo Velocidade Media deve ser numérico\n";
                }
                ...
                if (!campoNumerico(form.txtFrenagem.value)){
                    mensagem = mensagem + "O campo Frenagem deve ser numérico\n";
                }
                if (mensagem == ""){
                    return true;
                }else{
