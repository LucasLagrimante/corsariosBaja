...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form>
                <h3 align="center">Pesquisa de Design</h3>
                    ...
                    <tbody>
                        <c:forEach items="${designs}" var="design">
                            <tr>
                                ...
                                <td><a class="brown-text text-darken-4" href="ManterDesignController?acao=prepararEditar&idDesign=<c:out value="${design.idDesign}" />">Editar</a></td>
                                <td><a class="brown-text text-darken-4" href="ManterDesignController?acao=prepararExcluir&idDesign=<c:out value="${design.idDesign}" />">Excluir</a></td>
                            </tr>
                        </c:forEach>
                        <tr> 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#imprimir").click(function () {
            window.location.href = 'RelatorioController?relatorioNome=reportDesign.jasper';
        });
    });
</script>
