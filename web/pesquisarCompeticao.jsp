                        ...
                        <tbody>
                            <c:forEach items="${competicoes}" var="competicao">
                                <tr>
                                    ...
                                    <td><a class="brown-text text-darken-4" href="ManterCompeticaoController?acao=prepararEditar&idCompeticao=<c:out value="${competicao.idCompeticao}" />">Editar</a></td>
                                    <td><a class="brown-text text-darken-4" href="ManterCompeticaoController?acao=prepararExcluir&idCompeticao=<c:out value="${competicao.idCompeticao}" />">Excluir</a></td>
                                </tr>
                            </c:forEach>
                            <tr> 
