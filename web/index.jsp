            ...
            <ul class="menu">
                <li><a href="#">Cadastrar</a>
                    <ul>
                        ...
                        <li><a href="ManterTipoPecaController?acao=prepararIncluir">Tipo Peça</a></li>
                        <li><a href="ManterTipoPistaController?acao=prepararIncluir">Tipo Pista</a></li>
                ...
                <li><a href="#">Pesquisar</a>
                    <ul>
                        ...
                        <li><a href="PesquisaTipoPecaController">Tipo Peça</a></li>
                        <li><a href="PesquisaTipoPistaController">Tipo Pista</a></li>
                        ...
                        <li><a href="PesquisaDesempenhoController">Desempenho de Competição</a></li>
