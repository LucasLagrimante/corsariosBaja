...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form>
                <h3 align="center">Pesquisa de Investidor</h3>
                    ...
                    <tbody>
                        <c:forEach items="${investidores}" var="investidor">
                            <tr>
                                ...
                                <td><a class="brown-text text-darken-4" href="ManterInvestidorController?acao=prepararEditar&txtIdInvestidor=<c:out value="${investidor.idInvestidor}" />">Editar</a></td>
                                <td><a class="brown-text text-darken-4" href="ManterInvestidorController?acao=prepararExcluir&txtIdInvestidor=<c:out value="${investidor.idInvestidor}" />">Excluir</a></td>
                            </tr>
                        </c:forEach>
                        <tr> 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#imprimir").click(function () {
            window.location.href = 'RelatorioController?relatorioNome=reportInvestidor.jasper';
        });
    });
</script>