...
public class PesquisaDesempenhoTesteController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            request.setAttribute("desempenhosTestes", DesempenhoTeste.obterDesempenhosTestes());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PesquisaDesempenhoTesteController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
